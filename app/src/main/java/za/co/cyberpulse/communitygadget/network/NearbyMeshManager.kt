...
class NearbyMeshManager(
    ...
    @Volatile private var advertisingReady = false
    ...
    private val discoveryCallback = object : EndpointDiscoveryCallback() {
        ...
        override fun onEndpointLost(endpointId: String) { pendingEndpoints.remove(endpointId) }
    }
    ...
    private fun updateReady() {
        MeshRuntime.setNearbyReady(advertisingReady || discoveryReady)
    }
    ...
    private companion object {
        const val SERVICE_ID = "za.co.cyberpulse.communitygadget.offline.v2"
    }
}
